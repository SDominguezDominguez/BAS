...
INSERT INTO customer(id, name, customer_number, brand, email, advisor_id)
VALUES (1, 'Samantha', '12345', 'SNS', 'samantha@test.com', 1),
       (2, 'Jeffrey', '23456', 'RegioBank', 'jeffrey@test.com', 2),
       (3, 'Melissa', 'Melissa', 'BLG', 'melissa@test.com', 3);
